...
templates_path = [f'_templates'] # str(vision.get_html_template_path())
...
html_static_path = [f'_static']
html_css_files = ["custom.css"]

html_logo = f'_static/images/logo.jpg'
# The name of an image file (within the static path) to use as favicon of the
# docs.  This file should be a Windows icon file (.ico) being 16x16 or 32x32
# pixels large.
html_favicon = f'_static/images/favicon.jpg'
...
nb_execution_mode = "cache" # "cache" # "off" "force" "inline"
